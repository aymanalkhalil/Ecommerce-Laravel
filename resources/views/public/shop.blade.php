                        ...
                        <div class="col-12">
                            <div class="product-topbar d-flex align-items-center justify-content-between">
                                ...
                                <div class="total-products">
                                    @isset($all_products)
                                    <p><span>{{$all_products->count()}}</span> products found</p>
                                    @endisset
                                </div>
                                <!-- Sorting -->
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <img src="{{asset('images/product_images/' . $product->prod_image)}}" alt="">
                                    <!-- Hover Thumb -->
                                    {{-- <img class="hover-img" src="public/essence/img/product-img/product-2.jpg" alt=""> --}}
